...
* \[May 2024] **"Offline Training of Language Model Agents with Functions as Learnable Weights."** *Shaokun Zhang (PSU) et al.* ICML 2024. \[[paper](https://arxiv.org/pdf/2402.11359)] \[[code](https://github.com/ag2ai/ag2/blob/main/notebook/agentchat_agentoptimizer.ipynb) ⭐ 4,883 | 🐛 35 | 🌐 Python | 📅 2026-08-24]
* 🔥📖 \[Oct 2022] **"ReAct: Synergizing Reasoning and Acting in Language Models."** *Shunyu Yao (Princeton & Google Brain) et al.* ICLR 2023. \[[paper](https://arxiv.org/abs/2210.03629)] \[[code](https://github.com/ysymyth/ReAct) ⭐ 4,120 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2024-02-06] \[[project page](https://react-lm.github.io)]
...
* \[Oct 2023] **"Language Agent Tree Search Unifies Reasoning Acting and Planning in Language Models."** *Andy Zhou (UIUC) et al.* arXiv. \[[paper](https://arxiv.org/abs/2310.04406)] \[[code](https://github.com/andyz245/LanguageAgentTreeSearch) ⭐ 853 | 🐛 8 | 🌐 Python | 📅 2024-07-30] \[[project page](https://andyz245.github.io/LanguageAgentTreeSearch)]
...
* 🔥 \[Apr 2023] **"LLM+P: Empowering Large Language Models with Optimal Planning Proficiency."** *Bo Liu (UT Austin) et al.* arXiv. \[[paper](https://arxiv.org/abs/2304.11477)] \[[code](https://github.com/Cranial-XIX/llm-pddl) ⭐ 460 | 🐛 5 | 🌐 SAS | 📅 2023-09-27]
...
* 📖 \[May 2024] **"Can Graph Learning Improve Planning in LLM-based Agents?"** *Xixi Wu (CUHK) and Yifei Shen (MSRA) et al.* NeurIPS 2024. \[[paper](https://arxiv.org/abs/2405.19119)] \[[code](https://github.com/WxxShirley/GNN4TaskPlan) ⭐ 155 | 🐛 0 | 🌐 Python | 📅 2025-05-11] \[[chinese blog](https://zhuanlan.zhihu.com/p/936340518)]
...
* 📖 \[May 2023] **"AdaPlanner: Adaptive Planning from Feedback with Language Models."** *Haotian Sun (GaTech) et al.* NeurIPS 2023. \[[paper](https://arxiv.org/abs/2305.16653)] \[[code](https://github.com/haotiansun14/AdaPlanner) ⭐ 127 | 🐛 0 | 🌐 HTML | 📅 2025-03-31]
...
* 📖 \[Dec 2023] **"SayCanPay: Heuristic Planning with Large Language Models using Learnable Domain Knowledge."** *Rishi Hazra et al.* AAAI 2024 \[[paper](https://arxiv.org/pdf/2308.12682.pdf)] \[[code](https://github.com/RishiHazra/saycanpay) ⭐ 55 | 🐛 1 | 🌐 Python | 📅 2025-10-22] \[[project page](https://rishihazra.github.io/SayCanPay/)]
...
* 📖 \[May 2023] **"ChatCoT: Tool-Augmented Chain-of-Thought Reasoning on Chat-based Large Language Models."** *Zhipeng Chen (RUC) et al.* EMNLP 2023 Findings. \[[paper](https://arxiv.org/abs/2305.14323)] \[[code](https://github.com/RUCAIBOX/ChatCoT) ⭐ 47 | 🐛 0 | 🌐 Python | 📅 2023-06-02]
...
* 🔥 \[Aug 2023] **"MetaGPT: Meta Programming for Multi-Agent Collaborative Framework."** *Sirui Hong (DeepWisdom) et al.* arXiv. \[[paper](https://arxiv.org/abs/2308.00352)] \[[code](https://github.com/geekan/MetaGPT) ⭐ 69,995 | 🐛 131 | 🌐 Python | 📅 2026-01-21]
* 🔥 \[Aug 2023] **"AgentVerse: Facilitating Multi-Agent Collaboration and Exploring Emergent Behaviors in Agents."** *Weize Chen (THU) et al.* arXiv. \[[paper](https://arxiv.org/abs/2308.10848)] \[[code](https://github.com/OpenBMB/AgentVerse) ⭐ 5,114 | 🐛 35 | 🌐 JavaScript | 📅 2024-09-09]
...
* \[Aug 2023] **"LLM As DBA."** *Xuanhe Zhou (THU) et al.* arXiv. \[[paper](https://arxiv.org/abs/2308.05481)] \[[code](https://github.com/TsinghuaDatabaseGroup/DB-GPT) ⭐ 711 | 🐛 21 | 🌐 Python | 📅 2025-12-27]
* \[May 2023] **"Encouraging Divergent Thinking in Large Language Models through Multi-Agent Debate."** *Tian Liang (THU & Tencent) et al.* arXiv. \[[paper](https://arxiv.org/abs/2305.19118)] \[[code](https://github.com/Skytliang/Multi-Agents-Debate) ⭐ 608 | 🐛 0 | 🌐 Python | 📅 2025-12-16]
* \[May 2023] **"Improving Factuality and Reasoning in Language Models through Multiagent Debate."** *Yilun Du (MIT) et al.* arXiv. \[[paper](https://arxiv.org/abs/2305.14325)] \[[code](https://github.com/composable-models/llm_multiagent_debate) ⭐ 548 | 🐛 8 | 🌐 Python | 📅 2025-04-24] \[[project page](https://composable-models.github.io/llm_debate)]
* \[Jul 2023] **"Unleashing Cognitive Synergy in Large Language Models: A Task-Solving Agent through Multi-Persona Self-Collaboration."** *Zhenhailong Wang (UIUC & MSRA) et al.* arXiv. \[[paper](https://arxiv.org/abs/2307.05300)] \[[code](https://github.com/MikeWangWZHL/Solo-Performance-Prompting) ⭐ 354 | 🐛 2 | 🌐 Python | 📅 2024-05-08]
* \[Aug 2023] **"ChatEval: Towards Better LLM-based Evaluators through Multi-Agent Debate."** *Chi-Min Chan (THU) et al.* arXiv. \[[paper](https://arxiv.org/abs/2308.07201)] \[[code](https://github.com/chanchimin/ChatEval) ⭐ 341 | 🐛 8 | 🌐 Python | 📅 2024-10-19]
* \[Aug 2023] **"Gentopia: A Collaborative Platform for Tool-Augmented LLMs."** *Binfeng Xu et al.* arXiv. \[[paper](https://arxiv.org/abs/2308.04030)] \[[code](https://github.com/Gentopia-AI/Gentopia) ⭐ 328 | 🐛 3 | 🌐 Python | 📅 2023-11-27] \[[project page](https://gentopia-ai.github.io/Gentopia-AI-Homepage)]
* \[Jul 2023] **"Building Cooperative Embodied Agents Modularly with Large Language Models."** *Hongxin Zhang (UMass) et al.* arXiv. \[[paper](https://arxiv.org/abs/2307.02485)] \[[code](https://github.com/UMass-Foundation-Model/Co-LLM-Agents) ⭐ 307 | 🐛 6 | 🌐 Python | 📅 2025-03-30] \[[project page](https://vis-www.cs.umass.edu/Co-LLM-Agents)]
* \[Jul 2023] **"RoCo: Dialectic Multi-Robot Collaboration with Large Language Models."** *Mandi Zhao (Columbia) et al.* arXiv. \[[paper](https://arxiv.org/abs/2307.04738)] \[[code](https://github.com/MandiZhao/robot-collab) ⭐ 261 | 🐛 9 | 🌐 Python | 📅 2023-10-04] \[[project page](https://project-roco.github.io)]
* \[Oct 2023] **"Dynamic LLM-Agent Network: An LLM-agent Collaboration Framework with Agent Team Optimization."** *Zijun Liu (THU & Stanford) et al.* arXiv. \[[paper](https://arxiv.org/abs/2310.02170)] \[[code](https://github.com/SALT-NLP/DyLAN) ⭐ 213 | 🐛 9 | 🌐 Python | 📅 2024-05-16]
...
* \[Sep 2023] **"ReConcile: Round-Table Conference Improves Reasoning via Consensus among Diverse LLMs."** *Justin Chih-Yao Chen (UNC Chapel Hill) et al.* arXiv. \[[paper](https://arxiv.org/abs/2309.13007)] \[[code](https://github.com/dinobby/ReConcile) ⭐ 205 | 🐛 3 | 🌐 Python | 📅 2023-10-03]
* 📖 \[Jan 2024] **"L2MAC: Large Language Model Automatic Computer for Extensive Code Generation."** *Samuel Holt (Cambridge) et al.* ICLR 2024. \[[paper](https://arxiv.org/abs/2310.02003)] \[[code](https://github.com/samholt/l2mac) ⭐ 159 | 🐛 0 | 🌐 Python | 📅 2024-12-27] \[[project page](https://samholt.github.io/L2MAC/)]
* \[Oct 2023] **"Exploring Collaboration Mechanisms for LLM Agents: A Social Psychology View."** *Jintian Zhang (ZJU) et al.* arXiv. \[[paper](https://arxiv.org/abs/2310.02124)] \[[code](https://github.com/zjunlp/MachineSoM) ⭐ 120 | 🐛 0 | 🌐 Python | 📅 2025-06-06]
* \[Sep 2023] **"LLM-Deliberation: Evaluating LLMs with Interactive Multi-Agent Negotiation Games."** *Sahar Abdelnabi (CISPA) et al.* arXiv. \[[paper](https://arxiv.org/abs/2309.17234)] \[[code](https://github.com/S-Abdelnabi/LLM-Deliberation) ⭐ 55 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2024-11-11]
* \[Sep 2023] **"Scalable Multi-Robot Collaboration with Large Language Models: Centralized or Decentralized Systems?"** *Yongchao Chen (MIT & Harvard) et al.* arXiv. \[[paper](https://arxiv.org/abs/2309.15943)] \[[code](https://github.com/yongchao98/multi-agent-framework) ⭐ 51 | 🐛 0 | 🌐 Python | 📅 2024-09-26] \[[project page](https://yongchao98.github.io/MIT-REALM-Multi-Robot)]
* \[Oct 2023] **"Corex: Pushing the Boundaries of Complex Reasoning through Multi-Model Collaboration."** *Qiushi Sun (Shanghai AI Lab & NUS) et al.* arXiv. \[[paper](https://arxiv.org/abs/2310.00280)] \[[code](https://github.com/QiushiSun/Corex) ⭐ 31 | 🐛 0 | 🌐 Python | 📅 2024-10-18]
* \[April 2024] **"CoMM: Collaborative Multi-Agent, Multi-Reasoning-Path Prompting for Complex Problem Solving."** Pei Chen (TAMU) et al.\* NAACL 2024. \[[paper](https://arxiv.org/abs/2404.17729)] \[[code](https://github.com/amazon-science/comm-prompt) ⭐ 17 | 🐛 0 | 🌐 Python | 📅 2024-04-26]
* \[Jul 2023] **"PRD: Peer Rank and Discussion Improve Large Language Model based Evaluations."** *Ruosen Li (UT Dallas) et al.* arXiv. \[[paper](https://arxiv.org/abs/2307.02762)] \[[project page](https://bcdnlp.github.io/PR_LLM_EVAL/)]\[[code](https://github.com/bcdnlp/PRD) ⭐ 14 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2024-04-21]
* \[Aug 2023] **"How susceptible are LLMs to Logical Fallacies?"** *Amirreza Payandeh (GMU & Vail Systems) et al.* arXiv. \[[paper](https://arxiv.org/abs/2308.09853)] \[[code](https://github.com/Amir-pyh/LOGICOM) ⭐ 10 | 🐛 2 | 🌐 Python | 📅 2023-09-19]
* \[May 2024] **"Conformity, Confabulation, and Impersonation: Persona Inconstancy in Multi-Agent LLM Collaboration."** Razan Baltaji (UIUC) et al.\* arXiv. \[[paper](https://arxiv.org/abs/2310.05036)] \[[code](https://github.com/baltaci-r/CulturedAgents) ⭐ 4 | 🐛 1 | 🌐 Python | 📅 2024-10-08]
...
* 🔥 \[Aug 2023] **"AutoGen: Enabling Next-Gen LLM Applications via Multi-Agent Conversation Framework."** *Qingyun Wu et al.* arXiv. \[[paper](https://arxiv.org/abs/2308.08155)] \[[code](https://github.com/microsoft/autogen) ⭐ 60,607 | 🐛 998 | 🌐 Python | 📅 2026-04-15] \[[project page](https://microsoft.github.io/autogen/)]
...
* 🔥 \[Oct 2023] **"OpenAgents: An Open Platform for Language Agents in the Wild."** *Tianbao Xie (HKU & XLang Lab) et al.* arxiv. \[[paper](https://arxiv.org/abs/2310.10634)] \[[code](https://github.com/xlang-ai/OpenAgents) ⭐ 4,858 | 🐛 15 | 🌐 Python | 📅 2024-11-18]
...
* 🔥 \[Sep 2023] **"Cognitive Architectures for Language Agents."** *Theodore Sumers (Princeton) et al.* arXiv. \[[paper](https://arxiv.org/abs/2309.02427)] \[[repo](https://github.com/ysymyth/awesome-language-agents) ⭐ 1,250 | 🐛 8 | 🌐 TeX | 📅 2025-01-16]
...
* 🔥 \[Jul 2023] **"WebArena: A Realistic Web Environment for Building Autonomous Agents."** *Shuyan Zhou (CMU) et al.* arXiv. \[[paper](https://arxiv.org/abs/2307.13854)] \[[code](https://github.com/web-arena-x/webarena) ⭐ 1,586 | 🐛 101 | 🌐 Python | 📅 2025-11-26] \[[project page](https://webarena.dev)]
* 🔥📖 \[Jun 2023] **"Mind2Web: Towards a Generalist Agent for the Web."** *Xiang Deng (OSU) et al.* NeurIPS 2023. \[[paper](https://arxiv.org/abs/2306.06070)] \[[code](https://github.com/OSU-NLP-Group/Mind2Web) ⭐ 1,021 | 🐛 12 | 🌐 Jupyter Notebook | 📅 2025-11-05] \[[project page](https://osu-nlp-group.github.io/Mind2Web)]
* 📖 \[Jul 2022] **"WebShop: Towards Scalable Real-World Web Interaction with Grounded Language Agents."** *Shunyu Yao (Princeton) et al.* NeurIPS 2022. \[[paper](https://arxiv.org/abs/2207.01206)] \[[code](https://github.com/princeton-nlp/WebShop) ⭐ 586 | 🐛 18 | 🌐 Python | 📅 2024-09-06] \[[project page](https://webshop-pnlp.github.io)]
...
* \[Mar 2023] **"Language Models can Solve Computer Tasks."** *Geunwoo Kim (UCI) et al.* arXiv. \[[paper](https://arxiv.org/abs/2303.17491)] \[[code](https://github.com/posgnu/rci-agent) ⭐ 240 | 🐛 2 | 🌐 HTML | 📅 2024-05-01] \[[project page](https://posgnu.github.io/rci-web)]
* \[May 2023] **"Mobile-Env: An Evaluation Platform and Benchmark for Interactive Agents in LLM Era."** *Danyang Zhang (SJTU) et al.* arXiv. \[[paper](https://arxiv.org/abs/2305.08144)] \[[code](https://github.com/X-LANCE/Mobile-Env) ⭐ 64 | 🐛 1 | 🌐 Python | 📅 2025-09-24]
* \[Sep 2023] **"LASER: LLM Agent with State-Space Exploration for Web Navigation."** *Kaixin Ma (Tencent) et al.* arXiv. \[[paper](https://arxiv.org/abs/2309.08172)] \[[code](https://github.com/Mayer123/LASER) ⭐ 36 | 🐛 0 | 🌐 Python | 📅 2023-09-26]
...
* \[May 2024] **"Agentic Skill Discovery."** *Xufeng Zhao (UHH) et al.* arXiv. \[[paper](https://arxiv.org/abs/2405.15019)] \[[code](https://github.com/xf-zhao/Agentic-Skill-Discovery) ⭐ 32 | 🐛 1 | 🌐 Python | 📅 2025-02-13] \[[project page](https://agentic-skill-discovery.github.io/)]
* \[Aug 2023] **"LaGR-SEQ: Language-Guided Reinforcement Learning with Sample-Efficient Querying."** *Thommen George Karimpanal (Deakin University) et al.* arXiv. \[[paper](https://arxiv.org/abs/2308.13542)] \[[code](https://github.com/GKthom/LaGRSEQ) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2023-08-21]
...
* 🔥 \[May 2023] **"Voyager: An Open-Ended Embodied Agent with Large Language Models."** *Guanzhi Wang (NVIDIA & Caltech) et al.* arXiv. \[[paper](https://arxiv.org/abs/2305.16291)] \[[code](https://github.com/MineDojo/Voyager) ⭐ 7,157 | 🐛 8 | 🌐 JavaScript | 📅 2024-04-03] \[[project page](https://voyager.minedojo.org)]
* 🔥 \[May 2023] **"Ghost in the Minecraft: Generally Capable Agents for Open-World Environments via Large Language Models with Text-based Knowledge and Memory."** *Xizhou Zhu (THU & SenseTim) et al.* arXiv. \[[paper](https://arxiv.org/abs/2305.17144)] \[[code](https://github.com/OpenGVLab/GITM) ⭐ 643 | 🐛 12 | 📅 2023-06-05]
* \[Nov 2023] **"JARVIS-1: Open-world Multi-task Agents with Memory-Augmented Multimodal Language Models."** *Zihao Wang (PKU) et al.* arXiv. \[[paper](https://arxiv.org/abs/2311.05997)] \[[code](https://github.com/CraftJarvis/JARVIS-1) ⭐ 410 | 🐛 7 | 🌐 Java | 📅 2024-04-08] \[[project page](https://craftjarvis-jarvis1.github.io/)]
* \[Jul 2024] **"Odyssey: Empowering Agents with Open-World Skills."** *Shunyu Liu (Zhejiang University) et al.* arXiv. \[[paper](https://arxiv.org/abs/2407.15325)] \[[code](https://github.com/zju-vipa/Odyssey) ⭐ 402 | 🐛 3 | 🌐 Python | 📅 2025-10-22]
* \[Sep 2023] **"LLM-Grounder: Open-Vocabulary 3D Visual Grounding with Large Language Model as an Agent."** *Jianing Yang (UMich) et al.* arXiv. \[[paper](https://arxiv.org/abs/2309.12311)] \[[code](https://github.com/sled-group/chat-with-nerf) ⭐ 323 | 🐛 3 | 🌐 Python | 📅 2025-10-10] \[[project page](https://chat-with-nerf.github.io)]
...
* \[Jul 2023] **"Embodied Task Planning with Large Language Models."** *Zhenyu Wu (BUPT) et al.* arXiv. \[[paper](https://arxiv.org/abs/2307.01848)] \[[code](https://github.com/Gary3410/TaPA) ⭐ 196 | 🐛 8 | 🌐 Python | 📅 2023-08-22] \[[project page](https://gary3410.github.io/TaPA/)]
* \[Oct 2023] **"Towards End-to-End Embodied Decision Making via Multi-modal Large Language Model: Explorations with GPT4-Vision and Beyond."** *Liang Chen (PKU) et al.* arXiv. \[[paper](https://arxiv.org/abs/2310.02071)] \[[code](https://github.com/pkunlp-icler/PCA-EVAL) ⭐ 108 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2024-03-14] \[[project page](https://pca-eval.github.io)]
* \[Nov 2023] **"MP5: A Multi-modal Open-ended Embodied System in Minecraft via Active Perception"** *Yiran Qin (CUHKSZ) et al.* CVPR 2024. \[[paper](https://arxiv.org/abs/2312.07472)] \[[code](https://github.com/IranQin/MP5) ⭐ 107 | 🐛 2 | 🌐 Python | 📅 2024-06-30] \[[project page](https://iranqin.github.io/MP5.github.io/)]
* \[Jan 2023] **"Do Embodied Agents Dream of Pixelated Sheep: Embodied Decision Making using Language Guided World Modelling."** *Kolby Nottingham (UCI) et al.* ICML 2023. \[[paper](https://arxiv.org/abs/2301.12050)] \[[code](https://github.com/DeckardAgent/deckard) ⭐ 95 | 🐛 1 | 🌐 Python | 📅 2023-05-23] \[[project page](https://deckardagent.github.io)]
* \[Jun 2023] **"Enabling Intelligent Interactions between an Agent and an LLM: A Reinforcement Learning Approach."** *Bin Hu (Zhejiang Lab) et al.* arXiv. \[[paper](https://arxiv.org/abs/2306.03604)] \[[code](https://github.com/ZJLAB-AMMI/LLM4RL) ⭐ 81 | 🐛 1 | 🌐 Python | 📅 2024-08-22]
* \[Jul 2023] **"March in Chat: Interactive Prompting for Remote Embodied Referring Expression."** *Yanyuan Qiao (Adelaide University) et al.* arXiv. \[[paper](https://arxiv.org/abs/2308.10141)] \[[code](https://github.com/YanyuanQiao/MiC) ⭐ 27 | 🐛 3 | 🌐 Python | 📅 2024-05-22]
* \[Nov 2024] **"LABOR Agent: Large Language Models for Orchestrating Bimanual Robots"**, *Kun Chu (UHH) et al.* Humanoids 2024. \[[Paper](https://arxiv.org/abs/2404.02018)] \[[Website](https://labor-agent.github.io/)], \[[Code](https://github.com/Kchu/LABOR-Agent) ⭐ 24 | 🐛 1 | 🌐 Python | 📅 2024-11-23]
* \[Mar 2025] **"LLM+MAP: Bimanual Robot Task Planning using Large Language Models and Planning Domain Definition Language"**, *Kun Chu (UHH) et al.* arXiv. \[[Paper](https://arxiv.org/abs/2503.17309)], \[[Code](https://github.com/Kchu/LLM-MAP) ⭐ 23 | 🐛 1 | 📅 2025-03-24]
...
* 🔥📖 \[Mar 2023] **"CAMEL: Communicative Agents for "Mind" Exploration of Large Scale Language Model Society."** *Guohao Li (KAUST) et al.* NeurIPS 2023. \[[paper](https://arxiv.org/abs/2303.17760)] \[[code](https://github.com/camel-ai/camel) ⭐ 17,631 | 🐛 475 | 🌐 Python | 📅 2026-08-21] \[[project page](https://www.camel-ai.org)]
...
* \[Oct 2023] **"From Text to Tactic: Evaluating LLMs Playing the Game of Avalon."** *Jonathan Light (RPI) et al.* arXiv. \[[paper](https://arxiv.org/abs/2310.05036)] \[[code](https://github.com/jonathanmli/Avalon-LLM) ⭐ 162 | 🐛 2 | 🌐 Python | 📅 2025-05-30]
...
* 📖 \[May 2024] **"TimeChara: Evaluating Point-in-Time Character Hallucination of Role-Playing Large Language Models."** *Jaewoo Ahn (SNU) et al.* Findings of ACL 2024. \[[paper](https://arxiv.org/abs/2405.18027)] \[[code](https://github.com/ahnjaewoo/timechara) ⭐ 23 | 🐛 0 | 🌐 Python | 📅 2024-12-20] \[[project page](https://ahnjaewoo.github.io/timechara/)]
* \[May 2023] **"clembench: Using Game Play to Evaluate Chat-Optimized Language Models as Conversational Agents."** *Kranti Chalamalasetti (University of Potsdam) et al.* arXiv. \[[paper](https://arxiv.org/abs/2305.13455)] \[[code](https://github.com/clp-research/clembench) ⭐ 5 | 🐛 23 | 🌐 Python | 📅 2026-04-26]
...
* 🔥 \[Mar 2023] **"HuggingGPT: Solving AI Tasks with ChatGPT and its Friends in Hugging Face."** *Yongliang Shen (ZJU & MSRA) et al.* arXiv. \[[paper](https://arxiv.org/abs/2303.17580)] \[[code](https://github.com/microsoft/JARVIS) ⭐ 25,204 | 🐛 3,990 | 🌐 Python | 📅 2025-07-29]
* 🔥 \[Sep 2023] **"ModelScope-Agent: Building Your Customizable Agent System with Open-source Large Language Models."** *Chenliang Li (Alibaba) et al.* arXiv. \[[paper](https://arxiv.org/abs/2309.00986)] \[[code](https://github.com/modelscope/modelscope-agent) ⭐ 4,369 | 🐛 27 | 🌐 Python | 📅 2026-08-24] \[[demo](https://modelscope.cn/studios/damo/ModelScopeGPT/summary)]
...
* \[Apr 2023] **"GeneGPT: Augmenting Large Language Models with Domain Tools for Improved Access to Biomedical Information."** *Qiao Jin, Yifan Yang, Qingyu Chen, Zhiyong Lu* arXiv. \[[paper](https://arxiv.org/abs/2304.09667)] \[[code](https://github.com/ncbi/GeneGPT) ⭐ 430 | 🐛 0 | 🌐 Python | 📅 2025-05-08]
* \[May 2024] **"AgentClinic: a multimodal agent benchmark to evaluate AI in simulated clinical environments"** *Samuel Schmidgall (JHU & Stanford) et al.* arXiv. \[[paper](https://arxiv.org/pdf/2405.07960)] \[[code](https://github.com/samuelschmidgall/agentclinic) ⭐ 349 | 🐛 7 | 🌐 Python | 📅 2024-12-31] \[[project page](https://agentclinic.github.io/)]
* \[Oct 2023] **"OptiMUS: Optimization Modeling Using mip Solvers and large language models."** *Ali AhmadiTeshnizi (Stanford) et al.* arXiv. \[[paper](https://arxiv.org/abs/2310.06116)] \[[code](https://github.com/teshnizi/OptiMUS) ⭐ 289 | 🐛 2 | 🌐 Python | 📅 2025-11-04]
* \[Jan 2024] **"EHRAgent: Code Empowers Large Language Models for Few-shot Complex Tabular Reasoning on Electronic Health Records."** *Wenqi Shi (GaTech) et al.* arXiv. \[[paper](https://arxiv.org/abs/2401.07128)] \[[code](https://github.com/wshi83/EhrAgent) ⭐ 142 | 🐛 7 | 🌐 Python | 📅 2024-12-26] \[[project page](https://night-chen.github.io/EHR-Agent-page/)]
...
* \[Sep 2023] **"Identifying the Risks of LM Agents with an LM-Emulated Sandbox"** *Yangjun Ruan (University of Toronto & Vector Institute) et al.* arXiv. \[[paper](https://arxiv.org/abs/2309.15817)] \[[code](https://github.com/ryoungj/toolemu) ⭐ 220 | 🐛 2 | 🌐 Python | 📅 2024-03-22] \[[demo](https://demo.toolemu.com/)] \[[project page](https://toolemu.com/)]
...
* 🔥 \[Apr 2023] **"Generative Agents: Interactive Simulacra of Human Behavior."** *Joon Sung Park (Stanford) et al.* arXiv. \[[paper](https://arxiv.org/abs/2304.03442)] \[[code](https://github.com/joonspk-research/generative_agents) ⭐ 21,974 | 🐛 146 | 📅 2024-08-05]
...
* \[Jun 2023] **"RecAgent: A Novel Simulation Paradigm for Recommender Systems."** *Lei Wang (RUC) et al.* arXiv. \[[paper](https://arxiv.org/abs/2306.02552)] \[[code](https://github.com/RUC-GSAI/YuLan-Rec) ⭐ 417 | 🐛 4 | 🌐 Python | 📅 2025-04-01]
* \[Sep 2023] **"Identifying the Risks of LM Agents with an LM-Emulated Sandbox"** *Yangjun Ruan (University of Toronto & Vector Institute) et al.* arXiv. \[[paper](https://arxiv.org/abs/2309.15817)] \[[code](https://github.com/ryoungj/toolemu) ⭐ 220 | 🐛 2 | 🌐 Python | 📅 2024-03-22] \[[demo](https://demo.toolemu.com/)] \[[project page](https://toolemu.com/)]
...
* \[Oct 2023] **"Put Your Money Where Your Mouth Is: Evaluating Strategic Planning and Execution of LLM Agents in an Auction Arena."** *Jiangjie Chen (FDU & AI2) et al.* arXiv. \[[paper](https://arxiv.org/abs/2310.05746)] \[[code](https://github.com/jiangjiechen/auction-arena) ⭐ 51 | 🐛 0 | 🌐 Python | 📅 2024-01-28] \[[project page](https://auction-arena.github.io)]
* \[Mar 2024] **"Emergence of Social Norms in Large Language Model-based Agent Societies."** *Siyue Ren (NWPU) et al.* arXiv. \[[paper](https://arxiv.org/abs/2403.08251)] \[[code](https://github.com/sxswz213/CRSEC) ⭐ 49 | 🐛 1 | 🌐 Python | 📅 2025-10-22]
* \[Jul 2023] **"Epidemic Modeling with Generative Agents."** *Ross Williams (Virginia Tech) et al.* arXiv. \[[paper](https://arxiv.org/abs/2307.04986)] \[[code](https://github.com/bear96/GABM-Epidemic) ⭐ 35 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-13]
* \[Jul 2023] **"Are you in a Masquerade? Exploring the Behavior and Impact of Large Language Model Driven Social Bots in Online Social Networks."** *Siyu Li (SCU) et al.* arXiv. \[[paper](https://arxiv.org/abs/2307.10337)] \[[dataset](https://github.com/Litsay/Masquerade-23) ⭐ 28 | 🐛 1 | 📅 2026-01-28]
* \[Aug 2023] **"Exploring the Intersection of Large Language Models and Agent-Based Modeling via Prompt Engineering."** *Edward Junprung (UC Berkeley) et al.* arXiv. \[[paper](https://arxiv.org/abs/2308.07411)] \[[code](https://github.com/ejunprung/llm-agents) ⭐ 18 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2023-08-05]
...
* 🔥 \[May 2023] **"Training Socially Aligned Language Models in Simulated Human Society."** *Ruibo Liu (Dartmouth) et al.* arXiv. \[[paper](https://arxiv.org/abs/2305.16960)] \[[code](https://github.com/agi-templar/Stable-Alignment) ⭐ 357 | 🐛 4 | 🌐 Python | 📅 2023-06-18]
...
* \[Oct 2023] **"Agent Instructs Large Language Models to be General Zero-Shot Reasoners."** *Nicholas Crispino (WashU) et al.* arXiv. \[[paper](https://arxiv.org/abs/2310.03710)] \[[code](https://github.com/wang-research-lab/agentinstruct) ⭐ 124 | 🐛 1 | 🌐 Python | 📅 2025-10-20]
...
* 🔥 \[Aug 2023] **"AgentBench: Evaluating LLMs as Agents."** *Xiao Liu (THU) et al.* arXiv. \[[paper](https://arxiv.org/abs/2308.03688)] \[[code](https://github.com/THUDM/AgentBench) ⭐ 3,687 | 🐛 76 | 🌐 Python | 📅 2026-02-08] \[[project page](https://llmbench.ai/)]
* 📖 \[Jul 2024] **"AppWorld: A Controllable World of Apps and People for Benchmarking Interactive Coding Agents."** *Harsh Trivedi (Stony Brook University) et al.* ACL 2024. \[[paper](https://arxiv.org/abs/2407.18901)] \[[code](https://github.com/stonybrooknlp/appworld) ⭐ 490 | 🐛 18 | 🌐 Python | 📅 2026-02-17] \[[project page](https://appworld.dev/)]
* \[Oct 2023] **"Benchmarking Large Language Models As AI Research Agents."** *Qian Huang (Stanford) et al.* arXiv. \[[paper](https://arxiv.org/abs/2310.03302)] \[[code](https://github.com/snap-stanford/MLAgentBench) ⭐ 349 | 🐛 6 | 🌐 Python | 📅 2024-06-19]
* \[Dec 2023] **"T-Eval: Evaluating the Tool Utilization Capability of Large Language Models Step by Step."** *Zehui Chen (USTC, Shanghai AI Lab) et al.* arXiv. \[[paper](https://arxiv.org/abs/2312.14033)] \[[code](https://github.com/open-compass/T-Eval) ⭐ 313 | 🐛 39 | 🌐 Python | 📅 2024-04-03] \[[project page](https://open-compass.github.io/T-Eval/)]
* 📖 \[June 2023] **"ToolQA: A Dataset for LLM Question Answering with External Tools."** *Yuchen Zhuang (GaTech) et al.* NeurIPS 2023. \[[paper](https://arxiv.org/abs/2306.13304)] \[[code](https://github.com/night-chen/ToolQA) ⭐ 287 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2023-08-19]
* \[Sep 2023] **"Identifying the Risks of LM Agents with an LM-Emulated Sandbox"** *Yangjun Ruan (University of Toronto & Vector Institute) et al.* arXiv. \[[paper](https://arxiv.org/abs/2309.15817)] \[[code](https://github.com/ryoungj/toolemu) ⭐ 220 | 🐛 2 | 🌐 Python | 📅 2024-03-22] \[[demo](https://demo.toolemu.com/)] \[[project page](https://toolemu.com/)]
* \[Aug 2023] **"BOLAA: Benchmarking and Orchestrating LLM-augmented Autonomous Agents."** *Zhiwei Liu (Salesforce) et al.* arXiv. \[[paper](https://arxiv.org/abs/2308.05960)] \[[code](https://github.com/salesforce/BOLAA) ⭐ 193 | 🐛 8 | 🌐 Python | 📅 2026-06-02]
...
* 🔥 \[Sep 2023] **"The Rise and Potential of Large Language Model Based Agents: A Survey."** *Zhiheng Xi (FDU) et al.* arXiv. \[[paper](https://arxiv.org/abs/2309.07864)] \[[GitHub](https://github.com/WooooDyy/LLM-Agent-Paper-List) ⭐ 8,180 | 🐛 31 | 📅 2025-09-12]
* 🔥 \[Aug 2023] **"A Survey on Large Language Model based Autonomous Agents."** *Lei Wang (RUC) et al.* arXiv. \[[paper](https://arxiv.org/abs/2308.11432)] \[[GitHub](https://github.com/Paitesanshi/LLM-Agent-Survey) ⭐ 2,911 | 🐛 16 | 📅 2025-02-20]
...
* ![Auto-GPT Stars](https://img.shields.io/github/stars/Significant-Gravitas/Auto-GPT) [Auto-GPT](https://github.com/Significant-Gravitas/Auto-GPT) ⭐ 186,849 | 🐛 537 | 🌐 Python | 📅 2026-08-24 - An experimental open-source attempt to make GPT-4 fully autonomous.
* ![LangChain Stars](https://img.shields.io/github/stars/langchain-ai/langchain) [🦜️🔗 LangChain](https://github.com/langchain-ai/langchain) ⭐ 144,894 | 🐛 419 | 🌐 Python | 📅 2026-08-24 - Building applications with LLMs through composability.
* ![MetaGPT Stars](https://img.shields.io/github/stars/geekan/MetaGPT) [MetaGPT](https://github.com/geekan/MetaGPT) ⭐ 69,995 | 🐛 131 | 🌐 Python | 📅 2026-01-21 - 🌟 The Multi-Agent Framework: Given one line Requirement, return PRD, Design, Tasks, Repo.
...
* ![BabyAGI Stars](https://img.shields.io/github/stars/yoheinakajima/babyagi) [BabyAGI](https://github.com/yoheinakajima/babyagi) ⭐ 22,356 | 🐛 30 | 🌐 Python | 📅 2026-01-31 - An AI-powered task management system.
...
* ![Saplings Stars](https://img.shields.io/github/stars/shobrook/saplings) [Saplings](https://github.com/shobrook/saplings) ⭐ 276 | 🐛 0 | 🌐 Python | 📅 2025-07-27 – 🌳 Build smarter agents using tree search.
...
* ![AI Town Stars](https://img.shields.io/github/stars/a16z-infra/ai-town) [AI Town 🏠💻💌](https://github.com/a16z-infra/ai-town) ⭐ 10,384 | 🐛 72 | 🌐 TypeScript | 📅 2026-06-12 - A deployable starter kit for building and customizing your own version of AI town - a virtual town where AI characters live, chat and socialize.
* ![AgentVerse Stars](https://img.shields.io/github/stars/OpenBMB/AgentVerse) [🤖 AgentVerse 🪐](https://github.com/OpenBMB/AgentVerse) ⭐ 5,114 | 🐛 35 | 🌐 JavaScript | 📅 2024-09-09 - A flexible framework that simplifies the process of building custom multi-agent environments for large language models (LLMs).
* ![GPTeam Stars](https://img.shields.io/github/stars/101dotxyz/GPTeam) [GPTeam](https://github.com/101dotxyz/GPTeam) ⭐ 1,722 | 🐛 38 | 🌐 Python | 📅 2026-08-20 - An open-source multi-agent simulation.
* ![ChatArena Stars](https://img.shields.io/github/stars/chatarena/chatarena) [🏟 ChatArena](https://github.com/chatarena/chatarena) ⭐ 1,556 | 🐛 7 | 🌐 Python | 📅 2025-08-11 - Multi-agent language game environments for LLMs.
...
* [LLMAgentPapers](https://github.com/zjunlp/LLMAgentPapers) ⭐ 3,106 | 🐛 1 | 📅 2026-07-27 - Must-read papers on multiagents of LLMs.
* [LLM-Agents-Papers](https://github.com/AGI-Edgerunners/LLM-Agents-Papers) ⭐ 2,337 | 🐛 16 | 🌐 Python | 📅 2025-07-12 - A repo lists papers about LLM role playing, memory mechanism and LLM game playing.
